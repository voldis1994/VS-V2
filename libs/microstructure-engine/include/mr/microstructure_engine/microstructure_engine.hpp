...
/**
 * 10s Microstructure Brain — evidence layer (not a trading brain).
 *
...
public:
     ...
     * (keyed by open_time). Ignores non-10s candles.
     */
...
private:
    ...
    bool breakout_armed_up_{false};
    bool breakout_armed_down_{false};
